...
def main() -> None:
    ap = argparse.ArgumentParser(description="Wrapper for build_lightglue_tracks_npz.py with automatic K/Ks selection.")
    ...
    cmd = [sys.executable, str(REPO_ROOT / "tools" / "build_lightglue_tracks_npz.py")] + rest
    if k_npy.exists():
