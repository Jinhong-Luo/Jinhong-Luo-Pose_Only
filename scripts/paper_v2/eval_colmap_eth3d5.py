...
COLMAP_ROOT = REPO_ROOT / "COLMAP" / "ETH3D"
OUT_ROOT = REPO_ROOT / "runs" / "paper_v2" / "colmap_compare_eth3d5"

SCENES = [
    {
        "scene": "courtyard",
        "colmap_dir": COLMAP_ROOT / "courtyard",
        "prepared_dir": REPO_ROOT / "data" / "prepared" / "ETH3D" / "courtyard",
    },
    {
        "scene": "delivery_area",
        "colmap_dir": COLMAP_ROOT / "delivery_area",
        "prepared_dir": REPO_ROOT / "data" / "prepared" / "ETH3D" / "delivery_area",
    },
    {
        "scene": "office",
        "colmap_dir": COLMAP_ROOT / "office",
        "prepared_dir": REPO_ROOT / "data" / "prepared" / "ETH3D" / "office",
    },
    {
        "scene": "terrace",
        "colmap_dir": COLMAP_ROOT / "terrace",
        "prepared_dir": REPO_ROOT / "data" / "prepared" / "ETH3D" / "terrace",
    },
    {
        "scene": "electro",
        "colmap_dir": COLMAP_ROOT / "electro",
        "prepared_dir": REPO_ROOT / "data" / "prepared" / "ETH3D" / "electro",
    },
]
...
def main() -> None:
    ...
    for item in SCENES:
        ...
        prepared_dir = item["prepared_dir"]
        ...
        run([
            ...
            "--image_list", str(prepared_dir / "image_list.txt"),
        ...
        run([
            ...
            "--est_type", "c2w",
            "--gt_centers_npy", str(prepared_dir / "gt_centers.npy"),
            "--gt_unit_to_mm", "1000",
        ...
        run([
            ...
            "--gt_npy", str(prepared_dir / "R_abs_gt_w2c.npy"),
    ...
    csv_path = OUT_ROOT / "colmap_eth3d5_summary.csv"
    with csv_path.open("w", encoding="utf-8", newline="") as f:
        writer = csv.DictWriter(f, fieldnames=list(rows[0].keys()))
        writer.writeheader()
        writer.writerows(rows)

    print(f"saved COLMAP eth3d5 summary to: {csv_path}")
